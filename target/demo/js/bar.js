//也可以用$('#id').css({'':'','':''})这种统一加 
   //添加加载提示<p>
	 ...
	 $('#loadblock').css({'display':'none','height':'40px','lineheight':'35px','margin':'0 auto','text':'center','font':'medium/1.7em strong "\65B9\6B63\59DA\4F53",sans-serif','width':'15%'});
     ...
     newnode.innerHTML="正在加载请稍等.....";
	  ...
	  //comChartOne();      
	   ...
	   var y-rsidedata ;
	   var y-lsidedata ;
	   function datfl (x-data,y-rsidedata,y-lsidedata){
		   this.x-data =x-data;
		   this.y-rsidedata =y-rsidedata;
		   this.y-lsidedata =y-lsidedata;
	   }
...
//滚动条下拉动作
	 $(window).scroll(function () {
		           ...
		           if(scrollTop + windowHeight == scrollHeight) {
		        	   comLine();
		        	   datfl (x-data,y-rsidedata,y-lsidedata);
		        	   comAddF(x-data,y-rsidedata,y-lsidedata);
		        	 
						//$('.samechart').show();
		        	   $("#loadblock").fadeIn(3000,function(){$(this).text("已加载完成");});
						$("#loadblock").fadeOut(1000);
						setTimeout(function(){$(".samechart").slideDown(3000);},4000);
						...
						//$("samechart").setAttribute("display", "block");
		/*
...
function comLine(){
	   var title="新闻数据",
		 ...
		 */
		 ...
		 chart_line = document.getElementById('line'),
 ...
 require(
        ...
        function(ec){
			var myChart_line = ec.init(chart_line);
    ...
    setTimeout(function (){                         //摄者隐藏loading的时间
       myChart_line.hideLoading();
       var ecConfig = require('echarts/config');
       myChart_line.on(ecConfig.EVENT.CLICK, function(){window.open('http://www.baidu.com');});
...
function comPie(r_strF,r_strS){
  var chart_pie = document.getElementById('pie');
...
//	  r_strS= eval("(" + strS + ")"),
  ...
  require(
		...
		function(ec){
		    var myChart_pie=ec.init(chart_pie);
             ...
             // 为echarts对象加载数据 
               // myChart1.setOption(option1); 
				setTimeout(function (){
                   ...
                   var ecConfig = require('echarts/config');
                   myChart_pie.on(ecConfig.EVENT.CLICK, function(){window.open('http://www.baidu.com');});
...
function comMap(r_str){
 ...
 //       r_str= eval("(" + strS + ")"),
	   Chart_map=document.getElementById('map');
  require.config({  
        paths:{   
            'echarts' : 'js',  
        }
  ...
  require(
		...
		function(ec){
		  var myChart_map=ec.init(Chart_map);
		  ...
		  option_map={
			...
			setTimeout(function (){
                   ...
                   var ecConfig = require('echarts/config');
                   myChart_map.on(ecConfig.EVENT.CLICK, function(){window.open('http://www.baidu.com');});
...
function comWordCloud(str_S){
    ...
    require(
		...
		function(ec){
			var myChart_wordcloud=ec.init(document.getElementById('wordcloud'));
			//alert(str_S);
			myChart_wordcloud.showLoading({
               text : '正在努力加载数据中',
               effect :'bubble',
               textStyle : {
                  fontSize : 20,
    ...
    //        var str="[{ name:'Sam S Club', value: 10000},{name: 'Macys',value: 6181},{name: 'Amy Schumer',value: 4386,itemStyle: createRandomItemStyle(),},{name: 'Jurassic World',value: 4055}]",               
	 //           str_S= eval("(" + str+ ")");
			...
			setTimeout(function (){
                myChart_wordcloud.hideLoading();
                myChart_wordcloud.setOption(option_wordcloud);
                
                var ecConfig = require('echarts/config');
                myChart_wordcloud.on(ecConfig.EVENT.CLICK, function(param){
                	aa(param.name);
                	});
            },2200);
...
function comAddF(x-data,y-rsidedata,y-lsidedata){
		  ...
		  option_addF={
                ...
                series : [
                  ...
                  },
                  {
                   ...
                   itemStyle: {normal: {areaStyle: {type: 'default'}}},
                   data: (function(){
                      var oriData = y-lsidedata;    //前一天的新闻数据
...
//第一个图 今年与去年同一天的新闻总数对比
function comChartOne(){
    var chart_chartOne=document.getElementById('chartOne');
    ...
    require(
	   ...
	   function(ec){
	        var myChart_chartOne = ec.init(chart_chartOne);
        
	        myChart_chartOne.showLoading({
             text : '正在努力加载数据中',
             effect :'bubble',
             textStyle : {
                fontSize : 20,
            ...
            setTimeout(function (){
               myChart_chartOne.hideLoading();
			   var ecConfig = require('echarts/config');
               myChart_chartOne.on(ecConfig.EVENT.CLICK, function(){window.open('http://www.baidu.com');});
               myChart_chartOne.setOption(option_chartOne);
            },2200);

	       $(window).resize(function() {      //随窗口大小自适应变换宽高
                myChart_chartOne.resize();	
            }); 
